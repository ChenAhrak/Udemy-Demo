...
public class DBservices
{
    ...
    public int changeCourseTitle(int courseId, string title)
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        cmd = CreateCommandWithStoredProcedureChangeCourseTitle("SP_ChangeCourseTitle", con, courseId, title); // create the command
        try
        {
            int numEffected = cmd.ExecuteNonQuery(); // execute the command
            return numEffected;
    ...
    private SqlCommand CreateCommandWithStoredProcedureChangeCourseTitle(String spName, SqlConnection con, int courseId, string title)
    {
